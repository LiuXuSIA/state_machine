    ...
    { 
        ...
        { 
               ...
               position_data.data.substr(position_data.data.length() - 4,4) == "EEEE")
            {
                ...
                vision_position_raw.y = (R[1][0] * body_pose_x + R[1][1] * body_pose_y + R[1][2] * body_pose_z)/1000 + current_position.pose.position.x - 0.2;
                vision_position_raw.z = (R[2][0] * body_pose_x + R[2][1] * body_pose_y + R[2][2] * body_pose_z)/1000 - current_position.pose.position.z - 0.6;
