...
int main(int argc, char **argv)
{
    ...
    position_A.pose.position.z = 3;
    //position of B
    position_B.pose.position.x = 0;
    position_B.pose.position.y = 3;
    position_B.pose.position.z = 3;
    //position of C
    position_C.pose.position.x = 3;
    position_C.pose.position.y = 3;
    position_C.pose.position.z = 3;
